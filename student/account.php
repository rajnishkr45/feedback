    ...
    if (isset($_FILES['dp']) && $_FILES['dp']['error'] === UPLOAD_ERR_OK) {
        ...
        if (in_array(strtolower($file_ext), $allowed_ext)) {
            ...
            if (move_uploaded_file($file_tmp, '../dp/' . $new_file_name)) {
                ...
                $update_sql = "UPDATE students SET dp = '$new_file_name' WHERE email = '$student_email'";
...
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            $sql = "SELECT `id`, `name`,`email`, `branch`,`reg_no`,`semester`,`phone`,`dp` FROM `students` WHERE email='$semail'";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<h3>Er. " . $row['name'] . "</h3>";
                    echo "<p><span>Reg No:</span> " . $row['reg_no'] . "</p>";
                    echo "<p><span>Branch:</span> " . $row['branch'] . "</p>";
